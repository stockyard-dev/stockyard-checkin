...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Checkin</title>
...
<div class="hdr"><h1><span>&#9670;</span> CHECKIN</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('members')">Members</div><div class="tab" onclick="switchTab('checkins')">Check-Ins</div></div><div class="tab-content active" id="tab-members">
<div class="stats" id="stats-members"></div>
<div class="toolbar">
<input class="search" id="search-members" placeholder="Search..." oninput="renderRes('members')"><select class="filter-sel" id="filter-members-membership_type" onchange="renderRes('members')"><option value="">All Membership</option><option value="Monthly">Monthly</option><option value="Annual">Annual</option><option value="Drop-In">Drop-In</option><option value="Trial">Trial</option><option value="Staff">Staff</option></select><select class="filter-sel" id="filter-members-status" onchange="renderRes('members')"><option value="">All Status</option><option value="Active">Active</option><option value="Inactive">Inactive</option><option value="Suspended">Suspended</option><option value="Expired">Expired</option></select></div>
<div class="count-label" id="count-members"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Name</th><th>Email</th><th>Phone</th><th>Member ID</th><th>Membership</th><th>Status</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-members"></tbody></table></div></div><div class="tab-content" id="tab-checkins">
<div class="stats" id="stats-checkins"></div>
<div class="toolbar">
<input class="search" id="search-checkins" placeholder="Search..." oninput="renderRes('checkins')"></div>
<div class="count-label" id="count-checkins"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Member ID</th><th>Name</th><th>Check-In Time</th><th>Check-Out Time</th><th>Location</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-checkins"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="members";var resCfg={"members":{d:"Members",f:[{n:"name",l:"Name",t:"text",r:true,o:[]},{n:"email",l:"Email",t:"email",r:false,o:[]},{n:"phone",l:"Phone",t:"phone",r:false,o:[]},{n:"member_id",l:"Member ID",t:"text",r:false,o:[]},{n:"membership_type",l:"Membership",t:"select",r:false,o:["Monthly","Annual","Drop-In","Trial","Staff"]},{n:"status",l:"Status",t:"select",r:false,o:["Active","Inactive","Suspended","Expired"]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},"checkins":{d:"Check-Ins",f:[{n:"member_id",l:"Member ID",t:"text",r:true,o:[]},{n:"member_name",l:"Name",t:"text",r:false,o:[]},{n:"checked_in_at",l:"Check-In Time",t:"datetime",r:true,o:[]},{n:"checked_out_at",l:"Check-Out Time",t:"datetime",r:false,o:[]},{n:"location",l:"Location",t:"text",r:false,o:[]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},};
...
['members','checkins'].forEach(function(r){renderRes(r)});
}
}else{
